...
rename UGA405A UGA4051
rename UGA405B UGA4052
rename UGA405C UGA4053
foreach x in 1 2 3{
	recode UGA405`x' 1=0 2=1 *=0,gen(trump_disc`x')
 * 1 = Trump, 0 = Other
}

* dummy for Clinton vote
foreach x in 1 2 3 {
	recode UGA405`x' 1=1 2=0 *=0, gen(clint_disc`x')
 * 1 = Clinton, 0 = Other
}
