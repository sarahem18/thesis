...
gen vote_disc1 =.
replace vote_disc1 = NUC3A13 if disc_combo==1 | disc_combo==2 | disc_combo==3 | disc_combo==5
replace vote_disc1 = NUC3A14 if disc_combo==4 | disc_combo==6
replace vote_disc1 = NUC3A15 if disc_combo==7
replace vote_disc1 = 0 if vote_disc1 == .

gen vote_disc2 =.
replace vote_disc2 = NUC3A14 if disc_combo==1 | disc_combo==2
replace vote_disc2 = NUC3A15 if disc_combo==4 | disc_combo==5
replace vote_disc2 = 0 if vote_disc2 == .

gen vote_disc3=.
replace vote_disc3 = NUC3A15 if disc_combo==1
